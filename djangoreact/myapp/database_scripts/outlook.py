...
def send_schedule(record_response):
    ...
    # messages_left = inbox.Items.count
    # print(messages_left)
    # for i in range(messages_left):
    #     try:
    ...
    #         pass
        ...
        #future project: send the rest of emails to error folder
        #send email/slack to self with error count
...
#     field_name = 'EmailSent' 
#     data = 0
#     record_response = filemaker.find_record(field_name, data, token)
#     send_schedule(record_response)
#     data = 1
#     filemaker.edit_record(field_name, data, token, record_response)
#     messages_left = inbox.Items.count
#     print(messages_left)
