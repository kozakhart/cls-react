...
# login(browser) 
# token = filemaker.login()
# get_all = filemaker.get_all(token)

# browser.find_element("xpath", "//a[@title='Look up completed assessment ratings']").click()
# current_url = browser.current_url
# for i in get_all['response']['data']:
#     scores = i['fieldData']['Scores']
#     split_scores = scores.split("/")
#     if split_scores[0] != "" and split_scores[1] != "":
#         continue
#     first_name = i['fieldData']['FirstName']
#     last_name = i['fieldData']['LastName']
#     byuid = i['fieldData']['BYUID']
#     netid = i['fieldData']['NetID']
#     language = i['fieldData']['Language']
#     testdate1 = i['fieldData']['TestDate1']
#     testdate2 = i['fieldData']['TestDate2']
#     record_id = i['recordId']
#     final_score = get_score(first_name, last_name, byuid, netid, language, testdate1, testdate2)
#     filemaker.edit_record('Scores', final_score, token, record_id)
# filemaker.logout(token)
