...
export default function AppCurrentSubject({ title, subheader, chartData, chartColors, chartLabels, ...other }) {
  const chartOptions = {
    ...
    stroke: { width: 2 },
    fill: { opacity: 0.48 },
    legend: { floating: false, horizontalAlign: 'center',     onItemClick: {
  ...
  return (
    <Card {...other}>
      ...
      <StyledChartWrapper dir="ltr">
        <ReactApexChart type="radar" series={chartData} options={chartOptions} height={475} />
      </StyledChartWrapper>
      {/* <Box dir="ltr">
